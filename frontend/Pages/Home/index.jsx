...
const Home = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const categoriesRes = await fetch(
          `https://deepnetsoft-machinetest2-backend.onrender.com/api/menu/categories?t=${lastRefresh}`
        );
        ...
        const itemsRes = await fetch(
          `https://deepnetsoft-machinetest2-backend.onrender.com/api/menu?category=${activeCategory}&t=${lastRefresh}`
        );
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const response = await fetch('https://deepnetsoft-machinetest2-backend.onrender.com/api/menu', {
        method: 'POST',
